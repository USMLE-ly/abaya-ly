...
const sections = [
  ...
  },
  {
    ...
    content: "تُعتبر الطلب مؤكدّاً عند استلام الدفع. نقبل الدفع نقداً عند الاستلام.",
  },
  {
    title: "الشحن والتوصيل",
    content: "نقدم شحناً مجانيّاً داخل بنغازي. للمدن الأخرى تُطبق رسوم توصيل حسب كل مدينة وتظهر عند إتمام الطلب. مدة التوصيل داخل بنغازي يوم عمل واحد، وللمدن الأخرى ٣-٥ أيام عمل. يرجى الاطلاع على صفحة الشحن والتوصيل للتفاصيل الكاملة.",
  ...
  },
  {
    ...
    content: "جميع المحتويات على الموقع (نصوص، صور، شعارات، تصميمات) هي ملك حصري لشركة نادين. يُمنع أي نسخ أو استخدام بدون إذن كتابي مسبق.",
  },
  {
    title: "الخصوصية",
