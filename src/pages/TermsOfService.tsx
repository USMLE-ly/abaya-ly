...
const sections = [
  ...
  },
  {
    ...
    content: "نقدم شحناً مجانيّاً داخل بنغازي. للمدن الأخرى تُطبق رسوم توصيل حسب كل مدينة وتظهر عند إتمام الطلب. مدة التوصيل ٣-٥ أيام عمل. يرجى الاطلاع على صفحة الشحن والتوصيل للتفاصيل الكاملة.",
