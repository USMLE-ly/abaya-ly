...
const SECTIONS = [
  {
    ...
    summary: "نوصل لجميع المدن الليبية — مجاني داخل بنغازي، وبرسوم حسب المدينة لبقية المناطق",
    body: [
      "نوصل لجميع المدن الليبية — داخل بنغازي خلال يوم عمل واحد، وباقي المدن خلال 3-5 أيام عمل. الشحن مجاني داخل بنغازي فقط، وللمدن الأخرى تُطبق رسوم واضحة حسب المدينة.",
      "مدة التوصيل داخل بنغازي يوم عمل واحد، وللمدن الأخرى من 3 إلى 5 أيام عمل من تأكيد الطلب.",
