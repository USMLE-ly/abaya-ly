          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="glass-strong">
                <th className="text-right p-4 md:p-5 font-semibold text-white w-1/2">الميزة</th>
                <th className="p-4 md:p-5 text-center font-semibold text-brand bg-brand/5 w-1/4">الملكة</th>
                <th className="p-4 md:p-5 text-center font-semibold text-white/40 w-1/4">الآخرون</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row, i) => (
                <tr key={i} className="border-t border-white/5 hover:bg-white/[0.02] transition-colors">
                  <td className="p-4 md:p-5 text-white/80 font-medium">{row.benefit}</td>
