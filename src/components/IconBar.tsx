    ...
    <section className="py-20 md:py-32">
      <div className="mx-auto w-full max-w-6xl space-y-12 px-4">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold tracking-tight text-fg text-balance leading-tight">
            لماذا <span className="text-accent-brand">تختاريننا</span>؟
          </h2>
          <p className="mt-5 text-sm md:text-base tracking-wide text-fg/30 text-balance leading-relaxed max-w-xl mx-auto">
            نقدم لكِ ما لا تجدينه لدى الآخرين — جودة لا تُضاهى بلمسة ليبية أصيلة
          </p>
        </motion.div>

        <div className="grid grid-cols-1 divide-y divide-line-subtle border border-line-subtle sm:grid-cols-2 md:grid-cols-3">
