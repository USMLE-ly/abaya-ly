...
export function Awards({
  ...
  // ── Award (laurel wreath) ───────────────────────────────────────
  if (variant === "award") {
    // Full reference laurel wreath (designali-in/award — "award" variant).
    const LaurelWreath = () => (
      <svg
        className="absolute top-1/2 h-full w-full -translate-y-1/2"
        width="892.77"
        height="688.08"
