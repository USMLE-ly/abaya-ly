...
import { Truck, RotateCcw, Banknote, Scissors, MessageCircle, ShieldCheck } from "lucide-react";
...
const items = [
  ...
  { icon: Scissors, title: "تفصيل حسب المقاس", note: "خدمة مجانية عند الطلب", to: "/contact" },
