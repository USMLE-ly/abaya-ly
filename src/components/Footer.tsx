...
export function Footer() {
  return (
    <footer className="glass-subtle border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="font-semibold text-white mb-4 text-sm">خدمة العملاء</h4>
            <ul className="space-y-2.5 text-sm text-white/50">
          ...
          <div>
            <h4 className="font-semibold text-white mb-4 text-sm">تواصلي معنا</h4>
            <ul className="space-y-2.5 text-sm text-white/50">
              <li>طرابلس، ليبيا</li>
            ...
            <div className="flex gap-3 mt-4">
              <a href="#" className="w-9 h-9 rounded-full glass flex items-center justify-center text-white/50 hover:text-gold hover:bg-white/5 transition-all"><Instagram size={16} /></a>
              <a href="#" className="w-9 h-9 rounded-full glass flex items-center justify-center text-white/50 hover:text-gold hover:bg-white/5 transition-all"><Facebook size={16} /></a>
              <a href="#" className="w-9 h-9 rounded-full glass flex items-center justify-center text-white/50 hover:text-gold hover:bg-white/5 transition-all"><Twitter size={16} /></a>
            </div>
          </div>
        </div>
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-xs text-white/30">
