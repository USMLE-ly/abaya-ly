...
/**
 * Realistic laurel branches from the reference award component: two full
 * vector branches that wrap the award content, open at the crown — no
 * circular ring, no oval leaves. Thin gold foil gradient fill.
 */
function LaurelWreath() {
  return (
    ...
    >
      <defs>
        <linearGradient id="recognition-laurel-gold" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#ecd9ad" />
          <stop offset="100%" stopColor={GOLD_MID} />
        </linearGradient>
      </defs>
      <path d={LAUREL_BRANCH_RIGHT} fill="url(#recognition-laurel-gold)" data-laurel-leaf />
      <path d={LAUREL_BRANCH_LEFT} fill="url(#recognition-laurel-gold)" data-laurel-leaf />
    </svg>
  );
}
