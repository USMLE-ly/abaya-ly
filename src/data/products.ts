...
const meta: Record<string, Meta> = {
  ...
  "gold-embroidered-2": {
    ...
    highlights: [
      ...
      "خيوط ذهبية تزيّن الأكمام بتوقيع حِرفي.",
    ],
  ...
  "gold-embroidered-5": {
    ...
    highlights: [
      ...
      "لون أسود داكن عميق.",
      "خيوط ذهبية تمنح بريقاً هادئاً على الأسود.",
    ],
  ...
  "gold-embroidered-6": {
    ...
    highlights: [
      "قصّة ميرميد بكتف واحد وأكمام طويلة.",
      "لون نبيذي غامق عميق.",
      "لمسات ذهبية تضفي بريقاً هادئاً على النسيج.",
    ],
  ...
  "desert-gold": {
    ...
    highlights: [
      "لون ذهبي عتيق دافئ.",
      "خيوط ذهبية تمنح دفئاً على الذهبي العتيق.",
    ...
    tags: ["مطرّز","ذهبي-عتيق","سهرة","تطريز-يدوي","كريب","حِرفي","نسائي","مناسبات","Maison d'Or","Lina","فاخر","راقي","احتفالي","ملكي","خالد","دافئ","استثنائي","مساء","حفلات","توقيعي"],
  },
  "moonlight-silver": {
  ...
  "cherry-blossom": {
    ...
    highlights: [
      "أزهار كرز يدوية تزيّن الفستان برقة.",
