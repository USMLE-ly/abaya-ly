...
const base: BaseFields[] = [
  ...
  { id: "red-velvet", fabric: "ساتان فاخر", category: "السهرة", price: 840, originalPrice: 1190, badge: "حصري",
    colors: [{name:"أزرق سماوي",hex:"#a9d1e7"},{name:"أسود",hex:"#000000",linkTo:"noir-navy-polka-belted"},{name:"ذهبي",hex:"#FFD700",linkTo:"cream-silk"},{name:"وردي",hex:"#FFC0CB",linkTo:"white-lace"},{name:"كريمي",hex:"#f5f0e8",linkTo:"floral-sleeve"}],
  ...
  { id: "white-lace", fabric: "ساتان مطري", category: "الرسمية", price: 670, originalPrice: 920,
    colors: [{name:"وردي",hex:"#FFC0CB"},{name:"أسود",hex:"#000000",linkTo:"noir-navy-polka-belted"},{name:"ذهبي",hex:"#FFD700",linkTo:"cream-silk"},{name:"أزرق سماوي",hex:"#a9d1e7",linkTo:"red-velvet"},{name:"كريمي",hex:"#f5f0e8",linkTo:"floral-sleeve"}],
  ...
  { id: "floral-sleeve", fabric: "ساتان كلاسيكي", category: "الرسمية", price: 640, originalPrice: 880,
    colors: [{name:"كريمي",hex:"#f5f0e8"},{name:"أسود",hex:"#000000",linkTo:"noir-navy-polka-belted"},{name:"ذهبي",hex:"#FFD700",linkTo:"cream-silk"},{name:"أزرق سماوي",hex:"#a9d1e7",linkTo:"red-velvet"},{name:"وردي",hex:"#FFC0CB",linkTo:"white-lace"}],
