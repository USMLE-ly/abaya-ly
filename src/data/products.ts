...
const base: BaseFields[] = [
  ...
  { id: "lumiere-white-fitted-embroidered-mini", fabric: "قماش مطاطي", category: "الرسمية", price: 620, originalPrice: 860, badge: "جديد",
    colors: [{name:"أبيض",hex:"#FFFFFF"}], sizes: ["S","M","L","XL"], images: ["/outfits/white-fitted-embroidered-mini.jpg","/outfits/white-fitted-embroidered-mini-thumb.jpg"], rating: 4.8, reviewCount: 0 },
  { id: "noir-embroidered-short", fabric: "قماش ناعم مع شيفون", category: "السهرة", price: 680, originalPrice: 920, badge: "جديد",
    colors: [{name:"أسود",hex:"#000000"}], sizes: ["S","M","L","XL"], images: ["/outfits/noir-embroidered-short.jpg","/outfits/noir-embroidered-short-thumb.jpg"], rating: 4.8, reviewCount: 0 },
  ...
  { id: "lumiere-ivory-keyhole-mermaid", fabric: "قماش مطاطي مع دانتيل مطرز", category: "السهرة", price: 875, originalPrice: 1050, badge: "جديد",
    colors: [{name:"عاجي",hex:"#FFFFF0"}], sizes: ["S","M","L","XL"], images: ["/outfits/lumiere-ivory-keyhole-mermaid.jpg","/outfits/lumiere-ivory-keyhole-mermaid-thumb.jpg"], rating: 4.8, reviewCount: 0 },
  { id: "noir-black-keyhole-lace-mermaid", fabric: "دانتيل مطرز على ساتان", category: "السهرة", price: 980, originalPrice: 1150, badge: "جديد",
    colors: [{name:"أسود",hex:"#000000"}], sizes: ["S","M","L","XL"], images: ["/outfits/noir-black-keyhole-lace-mermaid.jpg","/outfits/noir-black-keyhole-lace-mermaid-thumb.jpg"], rating: 4.8, reviewCount: 0 },
...
const meta: Record<string, Meta> = {
  ...
  "lumiere-white-fitted-embroidered-mini": {
    code: "LM26-08",
    collection: "Lumière", model: "Tamara",
    descriptor: "فستان رسمي أبيض مطرز بقصة ضيقة ورقبة عالية",
    subtitle: "أبيض نقي بتطريز راقٍ وقصة ملاصقة.",
    description: "من مجموعة Lumière، Tamara فستان رسمي بلون أبيض نقي مع قماش مطاطي يحتضن الجسم بأناقة. رقبة عالية مطرزة تمنح إطلالة رسمية راقية، مع جسم ملاصق يرسم القوام بتناسق. حواف مزينة بتفاصيل دقيقة تضيف لمسة فاخرة. قصة ضيقة تمنح ثقة وحضوراً. قطعة تلائم المناسبات الرسمية والسهرات الأنيقة التي تستدعي نقاءً وذوقاً رفيعاً.",
    highlights: [
      "لون أبيض نقي بقماش مطاطي مريح.",
      "رقبة عالية مطرزة بحواف دقيقة.",
      "قصة ملاصقة للجسم بأناقة رسمية.",
    ],
    details: ["الطول: قصير","القصة: ضيقة ملاصقة برقبة عالية","اللون: أبيض مع تطريز","الخامة: قماش مطاطي","العناية: غسيل يدوي بارد"],
    seoName: "فستان رسمي أبيض مطرز بقصة ضيقة — مجموعة Lumière",
    slug: "lumiere-tamara-فستان-رسمي-أبيض-مطرز",
    tags: ["رسمي","أبيض","قصير","رقبة-عالية","تطريز","محدد-الجسم","قماش-مطاطي","نسائي","مناسبات","Lumière","Tamara","أنيق","راقي","سهرة","عصري","نقي","ربيع","صيف","إطلالة-رسمية","كلاسيكي"],
  },
  "noir-embroidered-short": {
    code: "NA26-10",
    collection: "Noir Atelier", model: "Lama",
    descriptor: "فستان سهرة أسود مطرز بقصة ضيقة ورقبة عالية",
    subtitle: "أسود أنيق مع شيفون مطرز عند الرقبة والتنورة.",
    description: "من مجموعة Noir Atelier، Lama فستان سهرة بلون أسود عميق مع قماش ناعم وشيفون مطرز يزين الرقبة وحواف التنورة. رقبة عالية مطرزة تمنح إطلالة راقية، مع تصميم ضيق ينسدل بانسيابية حول الجسم. لمسات الشيفون تضفي حركة ناعمة مع كل خطوة. قطعة تلائم أمسيات المدينة والمناسبات المسائية التي تستدعي أناقة داكنة حديثة.",
    highlights: [
      "شيفون مطرز على الرقبة والتنورة.",
      "رقبة عالية بإطلالة راقية.",
      "قصة ضيقة بقماش ناعم منسدل.",
    ],
    details: ["الطول: قصير","القصة: ضيقة برقبة عالية","اللون: أسود مع شيفون مطرز","الخامة: قماش ناعم مع شيفون","العناية: غسيل جاف فقط"],
    seoName: "فستان سهرة أسود مطرز بقصة ضيقة — مجموعة Noir Atelier",
    slug: "noir-atelier-lama-فستان-سهرة-أسود-مطرز",
    tags: ["سهرة","أسود","قصير","رقبة-عالية","تطريز","شيفون","محدد-الجسم","نسائي","مناسبات","Noir-Atelier","Lama","أنيق","راقي","مساء","عصري","جريء","خريف","شتاء","إطلالة-ليلية","سهرة-راقية"],
  },
  ...
  "lumiere-ivory-keyhole-mermaid": {
    code: "LM26-11",
    collection: "Lumière", model: "Eléna",
    descriptor: "فستان سهرة عاجي بقصة حورية البحر ورقبة عالية بفتحة مفتاحية وتطريز دانتيل",
    subtitle: "عاجي دافئ بتطريز دانتيل وقصة ميرميد ملكية.",
    description: "من مجموعة Lumière، Eléna فستان سهرة بلون عاجي دافئ بقماش مطاطي ناعم يرسم خطوط الجسم بذكاء. الجزء العلوي مزين بدانتيل مطرز يعانق الرقبة عبر رقبة عالية بفتحة مفتاحية تمنح إطلالة جذابة وراقية، مع تطريزات ناعمة تتلألأ عند الصدر. قصة حورية البحر تحتضن القوام ثم تنفتح نحو الأسفل بحركة منسدلة فاخرة تصل إلى الأرض. قطعة تلائم المناسبات الراقية وحفلات الزفاف التي تستدعي حضوراً ملكياً وأنوثة خالدة.",
    highlights: [
      "لون عاجي دافئ بقصة حورية البحر.",
      "رقبة عالية بفتحة مفتاحية أنيقة.",
      "تطريز دانتيل ناعم عند الجزء العلوي.",
    ],
    details: ["الطول: ماكسي","القصة: حورية البحر برقبة عالية بفتحة مفتاحية","اللون: عاجي مع دانتيل مطرز","الخامة: قماش مطاطي مع دانتيل مطرز","العناية: غسيل جاف فقط"],
    seoName: "فستان سهرة عاجي بقصة حورية البحر وتطريز دانتيل — مجموعة Lumière",
    slug: "lumiere-elena-فستان-سهرة-عاجي-ميرميد-دانتيل",
    tags: ["سهرة","عاجي","ماكسي","ميرميد","رقبة-عالية","دانتيل","تطريز","حورية-البحر","رومانسي","نسائي","مناسبات","Lumière","Eléna","فاخر","راقي","مساء","حفلات","أفراح","ملكي","ربيع","صيف","إطلالة-ملكية"],
  },
  "noir-black-keyhole-lace-mermaid": {
    code: "NA26-13",
    collection: "Noir Atelier", model: "Manon",
    descriptor: "فستان سهرة أسود بقصة حورية البحر ورقبة عالية بفتحة مفتاحية ودانتيل مطرز",
    subtitle: "أسود مطلق بدانتيل مطرز وقصة ميرميد درامية.",
    description: "من مجموعة Noir Atelier، Manon فستان سهرة بلون أسود عميق من الساتان الناعم مع مقدمة دانتيل مطرزة بزخارف زهرية دقيقة تمتد من الرقبة العالية نحو الخصر. فتحة مفتاحية في منتصف الرقبة تمنح إطلالة جذابة وغامضة، ورقبة عالية ترسم خطاً أنيقاً على الصدر. قصة ذيل السمكة تحتضن الجسم ثم تنساب نحو الأسفل بحركة درامية عند المشي. قطعة تلائم الحفلات الراقية والسهرات المسائية الخاصة التي تستدعي إطلالة فريدة لا تُنسى.",
    highlights: [
      "مقدمة دانتيل مطرزة بزخارف زهرية.",
      "رقبة عالية بفتحة مفتاحية جذابة.",
      "قصة ذيل السمكة بحركة درامية.",
    ],
    details: ["الطول: ماكسي","القصة: حورية البحر برقبة عالية بفتحة مفتاحية","اللون: أسود مع دانتيل مطرز","الخامة: دانتيل مطرز على ساتان","العناية: غسيل جاف فقط"],
    seoName: "فستان سهرة أسود بقصة حورية البحر ودانتيل مطرز — مجموعة Noir Atelier",
    slug: "noir-atelier-manon-فستان-سهرة-أسود-ميرميد-دانتيل",
    tags: ["سهرة","أسود","ماكسي","ميرميد","رقبة-عالية","دانتيل","تطريز","ساتان","ذيل-السمكة","نسائي","مناسبات","Noir-Atelier","Manon","فاخر","راقي","مساء","حفلات","غامض","خريف","شتاء","إطلالة-درامية"],
  },
