...
const base: BaseFields[] = [
  ...
  { id: "cream-silk", fabric: "حرير طبيعي", category: "الرسمية", price: 690, originalPrice: 950,
...
const meta: Record<string, Meta> = {
  "al-sahra-gold": {
    ...
    descriptor: "فستان سهرة أصفر ذهبي بنقاط بيضاء بقصة محدّدة الخصر",
    subtitle: "أصفر ذهبي مشرق بنقشة نقاط بيضاء كلاسيكية.",
    description: "من مجموعة Lumière، Céleste فستان سهرة بلون أصفر ذهبي دافئ مع نقاط بيضاء كلاسيكية تنتشر بإيقاع منتظم. قصّة محدّدة الخصر بحزام يبرز القوام بتناسق، مع رقبة مدورة وأكمام قصيرة منسدلة تضفي لمسة أنثوية. تنورة بقصة A تمنح حركة وانسيابية. ساتان فاخر بقوام متماسك يضمن ثباتاً وسقوطاً منظّماً. قطعة تلائم حفلات المساء والمناسبات الخاصة التي تستدعي إطلالة مشرقة وأنيقة.",
    highlights: [
      "لون أصفر ذهبي دافئ مع نقاط بيضاء كلاسيكية.",
      "رقبة مدورة وأكمام قصيرة منسدلة.",
      "خصر محدّد بحزام مع تنورة A.",
    ],
    details: ["الطول: ميدي","القصة: محدّدة الخصر بحزام وتنورة A","اللون: أصفر ذهبي بنقاط بيضاء","الخامة: ساتان فاخر","العناية: غسيل جاف فقط"],
    seoName: "فستان سهرة أصفر ذهبي بنقاط بيضاء — مجموعة Lumière",
    slug: "lumiere-celeste-فستان-أصفر-ذهبي-منقط",
    tags: ["سهرة","أصفر","ذهبي","نقاط-بيضاء","ميدي","حزام","محدد-الخصر","تنورة-A","ساتان","كلاسيكي","نسائي","مناسبات","Lumière","Céleste","أنيق","راقي","ربيع","صيف","متوسطي","حفلات","خالد"],
  },
  "olive-ruffle": {
  ...
  "floral-sleeve": {
    ...
    details: ["الطول: ميدي","القصة: محدّدة الخصر بحزام","اللون: كريمي بنقاط داكنة","الخامة: ساتان فاخر","العناية: غسيل جاف فقط"],
  ...
  "mesh-geometric": {
    ...
    descriptor: "فستان سهرة أسود بنقاط بيضاء بقصة محدّدة الخصر بحزام",
    subtitle: "أسود بنقاط بيضاء بأناقة محدّدة وعصرية.",
    description: "من مجموعة Noir Atelier، Rania فستان سهرة بلون أسود عميق مع نقاط بيضاء كلاسيكية تنتشر بإيقاع منتظم. رقبة مدورة عالية وأكمام قصيرة منسدلة تمنح إطلالة أنثوية متوازنة. خصر محدّد بحزام مع تنورة بقصة A تمنح حرية حركة وانسيابية. ساتان مطري بقوام متماسك يضمن ثباتاً وسقوطاً منظّماً. قطعة تجمع بين الكلاسيكية والعصرية، تليق بالمناسبات النهارية الرسمية والتجمّعات المسائية الراقية.",
    highlights: [
      "لون أسود مع نقاط بيضاء كلاسيكية.",
      "رقبة مدورة عالية وأكمام قصيرة منسدلة.",
      "خصر محدّد بحزام مع تنورة A.",
    ],
    details: ["الطول: ميدي","القصة: محدّدة الخصر بحزام","اللون: أسود بنقاط بيضاء","الخامة: ساتان مطري","العناية: غسيل جاف فقط"],
    seoName: "فستان سهرة أسود بنقاط بيضاء بقصة محدّدة الخصر — مجموعة Noir Atelier",
    slug: "noir-atelier-rania-فستان-أسود-منقط-بحزام",
    tags: ["سهرة","أسود","نقاط-بيضاء","ميدي","حزام","محدد-الخصر","ساتان","كلاسيكي","نسائي","مناسبات","Noir-Atelier","Rania","أنيق","راقي","مساء","حفلات","نهاري","خالد","إطلالة-كلاسيكية","تجمّعات"],
  },
  "navy-tie-neck": {
  ...
  "midnight-rose": {
    ...
    details: ["الطول: ميدي","القصة: بقصة قلب وأشرطة رفيعة","اللون: أحمر زاهي بنقاط بيضاء","الخامة: ساتان مخملي","العناية: غسيل جاف فقط"],
