...
const base: BaseFields[] = [
  ...
  { id: "azure-navy-gold-asymmetric", fabric: "جورجيت فاخر", category: "السهرة", price: 890, originalPrice: 1150, badge: "جديد",
    colors: [{name:"أزرق نيلي",hex:"#1A1F3A"}], sizes: ["S","M","L","XL"], images: ["/outfits/azure-navy-gold-asymmetric.jpg","/outfits/azure-navy-gold-asymmetric-thumb.jpg"], rating: 4.8, reviewCount: 0 },
...
const meta: Record<string, Meta> = {
  ...
  "azure-navy-gold-asymmetric": {
    code: "AZ26-06",
    collection: "Azure", model: "Selene",
    descriptor: "فستان سهرة أزرق نيلي بقصة ملفوفة ورقبة غير متماثلة على كتف واحدة وتفاصيل ذهبية",
    subtitle: "أزرق نيلي عميق بتفاصيل ذهبية وقصة ملفوفة ملكية.",
    description: "من مجموعة Azure، Selene فستان سهرة بلون أزرق نيلي عميق من الجورجيت الفاخر بقوام متدفق ولمعة راقية. قصة ملفوفة ترسم خطوط الجسم برشاقة، مع رقبة غير متماثلة تنسدل على الكتف الأيسر بثنيات أنيقة وأكمام عارية تبرز الكتفين. حلقات معدنية ذهبية عند الكتف والخصر تضيف لمسة متألقة، وطول متوسط يصل إلى الساق. قطعة تلائم حفلات المساء والسهرات الراقية التي تستدعي حضوراً ملكياً وأناقة خالدة.",
    highlights: [
      "لون أزرق نيلي عميق بقوام متدفق.",
      "رقبة غير متماثلة على كتف واحدة بأكمام عارية.",
      "حلقات ذهبية عند الكتف والخصر.",
    ],
    details: ["الطول: متوسط","القصة: ملفوفة برقبة غير متماثلة","اللون: أزرق نيلي مع تفاصيل ذهبية","الخامة: جورجيت فاخر","العناية: غسيل جاف فقط"],
    seoName: "فستان سهرة أزرق نيلي بقصة ملفوفة وتفاصيل ذهبية — مجموعة Azure",
    slug: "azure-selene-فستان-سهرة-أزرق-نيلي-ذهبي",
    tags: ["سهرة","أزرق-نيلي","كحلي","غير-متماثل","كتف-واحدة","أكمام-عارية","حلقات-ذهبية","جورجيت","ملفوف","محدد-الجسم","نسائي","مناسبات","Azure","Selene","فاخر","راقي","مساء","حفلات","ملكي","خريف","شتاء","إطلالة-ملكية"],
  },
