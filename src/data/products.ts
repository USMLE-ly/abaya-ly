...
const meta: Record<string, Meta> = {
  "al-sahra-gold": {
    ...
    descriptor: "فستان سهرة أبيض بنقاط سوداء كلاسيكية",
  ...
  "olive-ruffle": {
    ...
    descriptor: "فستان سهرة أسود منقّط بحزام مزخرف",
  ...
  "cream-silk": {
    ...
    descriptor: "فستان رسمي ذهبي منقّط بأكمام ناعمة",
  ...
  "white-beach": {
    ...
    descriptor: "فستان كاجوال نبيذي بياقة V وأكمام منسابة",
    subtitle: "نبيذ عميق بلمسة أنوثة نهاريّة.",
    description: "من مجموعة Rouge Héritage، Ophélie فستان نهاري بلون نبيذي عميق يجمع بين الدفء والرقيّ. ياقة V تفتح خطاً أنثوياً متوازناً، وأكمام منسابة تمنح إحساساً بالراحة والحركة. القصة محتشمة تلائم أوقاتاً متعدّدة، من غداء أنيق إلى لقاء عائلي راقٍ. شيفون فاخر خفيف يتماوج مع الحركة ويمنح إطلالة رشيقة. لون واحد قوي يكفي وحده لبناء حضور واثق دون الحاجة إلى تفاصيل زائدة.",
    highlights: [
  ...
  "red-velvet": {
    ...
    descriptor: "فستان سهرة أزرق سماوي بحزام مزخرف",
  ...
  "black-lace": {
    ...
    descriptor: "فستان سهرة كحلي غامق بأكمام بوف وياقة V",
    subtitle: "كحلي عميق بحضور مسائي واثق.",
    description: "قطعة من مجموعة Azure بلون كحلي غامق يقترب من صفاء الليل. Colette فستان سهرة بأكمام بوف تمنح الكتف حضوراً أنثوياً، وياقة V تفتح خطاً متوازناً. أزرار أمامية تضيف بُعداً كلاسيكياً هادئاً، والقصة تلائم المناسبات المسائية الرسمية. ساتان بلمسة تركيبية دقيقة يمنح النسيج ثقلاً فاخراً وحركة رشيقة. اختيار مضمون لمن تفضّل الألوان العميقة على الأسود التقليدي، مع الحفاظ على نفس الحضور الليلي القوي.",
    highlights: [
  ...
  "night-velvet": {
    ...
    descriptor: "فستان سهرة أبيض منقّط بكتف مكشوف وحزام",
  ...
  "floral-sleeve": {
    ...
    descriptor: "فستان رسمي كريمي محتشم بأكمام ناعمة",
  ...
  "navy-tie-neck": {
    ...
    descriptor: "فستان كاجوال أبيض بأربطة رقبة وأكمام منسابة",
  ...
  "white-polka-dot": {
    ...
    descriptor: "فستان كاجوال عنابي بأكمام منسابة",
  ...
  "midnight-rose": {
    ...
    descriptor: "فستان سهرة عنابي مخملي",
