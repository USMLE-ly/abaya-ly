...
export default function Settings() {
  ...
  const input = (
    ...
    <div>
      <p className="text-[12px] font-bold mb-1.5" style={{ color: "var(--ad-text-4)" }}>{label}</p>
      <AInput
        icon={icon}
        type={opts?.type || "text"}
        value={settings[key]}
  ...
  return (
    <div className="flex flex-col gap-5 max-w-3xl">
      ...
      <ACard className="p-5 sm:p-6">
        <h3 className="text-[15px] font-extrabold mb-4 flex items-center gap-2" style={{ color: "var(--ad-text)" }}>
      ...
      <ACard className="p-5 sm:p-6">
        ...
        <div>
          <p className="text-[12px] font-bold mb-1.5" style={{ color: "var(--ad-text-4)" }}>معلومات الشحن</p>
          <textarea
